...
class NetworkConfigGenerator:
  ...
  def generateL1L2(self):
    ...
    self.configFile.write("DefaultBandwidth = 4096000\n") 
  ...
  def generateL2GmKim(self):
    ...
    for i in range(0, config.numGpu):
      ...
      for j in range(0, config.numL2PerGpu):
        ...
        self.configFile.write((
          "\n[Network." + config.l2GmNetworkName
          + ".Node.localswitch" + str(l2Id) + "]\n"
          "Type = Switch\n"))
        self.configFile.write((
          "\n[Network." + config.l2GmNetworkName
          + ".Link.l2n" + str(l2Id) + "-localswitch" + str(l2Id) + "]\n"
          "Type = Bidirectional\n"
          "Source = l2n" + str(l2Id) + "\n"
          "Dest = localswitch" + str(l2Id) + "\n"))
        self.configFile.write((
          "\n[Network." + config.l2GmNetworkName
          + ".Link.localswitch" + str(l2Id) + "-switch" + str(i) + "]\n"
          "Type = Bidirectional\n"
          "Source = localswitch" + str(l2Id) + "\n"
          "Dest = switch" + str(i) + "\n"))
        self.configFile.write((
          "\n[Network." + config.l2GmNetworkName
        ...
        self.configFile.write((
          "\n[Network." + config.l2GmNetworkName
          + ".Link.GDDR5bus" + str(l2Id) + "-localswitch" + str(l2Id) + "]\n"
          "Type = Bidirectional\n"
